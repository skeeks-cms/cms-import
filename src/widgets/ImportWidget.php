 ...
 * @date 30.08.2016
 */
namespace skeeks\cms\import\widgets;
...
{
    public static $autoIdPrefix = 'ImportWidget';
    ...
    public function init()
    {
        ...
        $this->clientOptions = ArrayHelper::merge([
            'backend'       => \skeeks\cms\helpers\UrlHelper::construct(['/cmsImport/admin-import-task/import'])->enableAdmin()->toString(),
            'id'                => $this->options['id'],
